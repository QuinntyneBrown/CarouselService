...
const template = require("./carousel-item-embed.component.html");
const styles = require("./carousel-item-embed.component.scss");

export class CarouselItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new CarouselDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new CarouselEdit(this.entity));
    }
    ...
    public entity: Carousel;
}

customElements.define(`ce-carousel-item-embed`,CarouselItemEmbedComponent);
