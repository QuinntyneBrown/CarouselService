...
export class AppRouterOutletComponent extends RouterOutlet {
    ...
    connectedCallback() {
        this.setRoutes([
            { path: "/", name: "carousel-master-detail", authRequired: true },

            { path: "/carousel-items", name: "carousel-master-detail", authRequired: true },

            { path: "/carousel/:carouselId", name: "carousel-master-detail", authRequired: true },
