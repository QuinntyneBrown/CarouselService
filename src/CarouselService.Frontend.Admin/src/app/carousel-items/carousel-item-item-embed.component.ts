...
const template = require("./carousel-item-item-embed.component.html");
const styles = require("./carousel-item-item-embed.component.scss");

export class CarouselItemItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new CarouselItemDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new CarouselItemEdit(this.entity));
    }
    ...
    public entity: CarouselItem;
}

customElements.define(`ce-carousel-item-item-embed`,CarouselItemItemEmbedComponent);
