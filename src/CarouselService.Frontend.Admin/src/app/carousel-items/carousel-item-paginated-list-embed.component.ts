...
const template = require("./carousel-item-paginated-list-embed.component.html");
const styles = require("./carousel-item-paginated-list-embed.component.scss");

export class CarouselItemPaginatedListEmbedComponent extends PaginatedComponent<CarouselItem> {
    constructor(
    ...
    public render() {
        ...
        for (let i = 0; i < this.pagedList.data.length; i++) {            
            const el = this._document.createElement(`ce-carousel-item-item-embed`);
...
customElements.define("ce-carousel-item-paginated-list-embed", CarouselItemPaginatedListEmbedComponent);
