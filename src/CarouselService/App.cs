...
using static CarouselService.Features.Core.WebApiUnityActionFilterProvider;

namespace CarouselService
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "CarouselService"))
                .EnableSwaggerUi();
