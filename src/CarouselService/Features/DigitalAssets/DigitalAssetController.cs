using MediatR;
using CarouselService.Features.DigitalAssets.UploadHandlers;
...
using static CarouselService.Features.DigitalAssets.GetDigitalAssetByUniqueIdQuery;
using static CarouselService.Features.DigitalAssets.AzureBlobStorageDigitalAssetCommand;
using static CarouselService.Features.DigitalAssets.GetDigitalAssetsQuery;
using static CarouselService.Features.DigitalAssets.GetDigitalAssetByIdQuery;
using static CarouselService.Features.DigitalAssets.RemoveDigitalAssetCommand;
using static CarouselService.Features.DigitalAssets.AddOrUpdateDigitalAssetCommand;
