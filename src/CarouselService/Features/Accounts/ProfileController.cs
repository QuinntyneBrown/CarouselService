...
using static CarouselService.Features.Accounts.AddOrUpdateProfileCommand;
using static CarouselService.Features.Accounts.GetProfilesQuery;
using static CarouselService.Features.Accounts.GetProfileByIdQuery;
using static CarouselService.Features.Accounts.RemoveProfileCommand;
