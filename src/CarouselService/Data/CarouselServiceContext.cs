...
namespace CarouselService.Data
{
    public interface ICarouselServiceContext
    {
        DbSet<User> Users { get; set; }
        DbSet<Role> Roles { get; set; }
        DbSet<Tenant> Tenants { get; set; }
        DbSet<DigitalAsset> DigitalAssets { get; set; }
        DbSet<Carousel> Carousels { get; set; }
        DbSet<CarouselItem> CarouselItems { get; set; }
        DbSet<Account> Accounts { get; set; }
        DbSet<Profile> Profiles { get; set; }
        Task<int> SaveChangesAsync();
    }

    public class CarouselServiceContext: DbContext, ICarouselServiceContext
    {
        public CarouselServiceContext()
            :base("CarouselServiceContext")
        {
